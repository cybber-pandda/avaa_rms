...
function BlockUserForm({ onBlock }: { onBlock: (user: SearchResult & { reason?: string }) => void }) {
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Block a User</h3>
                ...
                <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-500">{selectedUser.subtitle}</p>
                        </div>
                    </div>
...
/* ── Main Component ── */
export default function BlockedUsers({ auth }: PageProps<{ auth: any }>) {
    ...
    return (
        <AppLayout>
            <Head title="Blocked Users - Settings" />
